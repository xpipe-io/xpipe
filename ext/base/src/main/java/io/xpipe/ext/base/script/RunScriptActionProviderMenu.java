...
public class RunScriptActionProviderMenu implements BranchStoreActionProvider<ShellStore>, BatchStoreActionProvider<ShellStore> {
        ...
        public boolean isMutation() {
            return true;
                ...
                public RunTerminalScriptActionProvider.Action createAction(DataStoreEntryRef<ShellStore> ref) {
                    return RunTerminalScriptActionProvider.Action.builder().ref(ref).scriptStore(hierarchy.getLeafBase()).build();
                }
    ...
    private static class HubRunActionProvider
        ...
        public RunHubScriptActionProvider.Action createAction(DataStoreEntryRef<ShellStore> ref) {
            return RunHubScriptActionProvider.Action.builder().ref(ref).scriptStore(hierarchy.getLeafBase()).build();
        }

        @Override
        public AbstractAction createBatchAction(List<DataStoreEntryRef<ShellStore>> stores) {
            return RunHubBatchScriptActionProvider.Action.builder().refs(stores).scriptStore(hierarchy.getLeafBase()).build();
        }
    ...
    private static class BackgroundRunActionProvider
        ...
        public RunBackgroundScriptActionProvider.Action createAction(DataStoreEntryRef<ShellStore> ref) {
            return RunBackgroundScriptActionProvider.Action.builder().ref(ref).scriptStore(hierarchy.getLeafBase()).build();
        }
    ...
    private static class NoScriptsActionProvider
        ...
        @Override
        public AbstractAction createBatchAction(List<DataStoreEntryRef<ShellStore>> stores) {
            return CategorySelectActionProvider.Action.builder().ref(stores.getFirst().asNeeded()).build();
        }

        @Override
                public StoreAction<ShellStore> createAction(DataStoreEntryRef<ShellStore> ref) {
                    return CategorySelectActionProvider.Action.builder().ref(ref.asNeeded()).build().asNeeded();
                }
    ...
    private static class ScriptsDisabledActionProvider
            implements LeafStoreActionProvider<ShellStore>, BatchStoreActionProvider<ShellStore> {
                ...
                @Override
                public StoreAction<ShellStore> createAction(DataStoreEntryRef<ShellStore> ref) {
                    return CategoryConfigActionProvider.Action.builder().ref(ref.asNeeded()).build().asNeeded();
                }
    ...
    private static class NoStateActionProvider
        ...
        @Override
                ...
                @Override
                public StoreAction<ShellStore> createAction(DataStoreEntryRef<ShellStore> ref) {
                    return RefreshStoreActionProvider.Action.builder().ref(ref.asNeeded()).build().asNeeded();
        }
    }
