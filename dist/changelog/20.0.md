...
There is now a new batch action to open multiple systems in a split terminal pane instead of individual tabs. This action is only supported for terminals that support this, which currently includes: Windows Terminal, Kitty, and WezTerm.

![Split Action](https://xpipe.io/assets/images/BlogPage/split-bar.png)

This allows you to also use a feature like broadcast mode of your terminal to type one command into multiple terminals at the same time.
