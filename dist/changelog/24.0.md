...
- Upgrading directly to v24 is only possible from [v23.99](https://github.com/xpipe-io/xpipe/releases/tag/23.99). If you are running an earlier version of XPipe, please update first to v23.99 and launch it once to initiate a vault migration. After that is done, you can upgrade to v24.
