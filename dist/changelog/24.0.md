...
- Upgrading directly to v24 is only possible from [v23.99](https://github.com/xpipe-io/xpipe/releases/tag/23.99.1). If you are running an earlier version of XPipe, please update first to v23.99 and launch it once to initiate a vault migration. After that is done, you can upgrade to v24.
...
- The webtop container has been completely overhauled and improved. It has been moved away from KasmVNC to Selkies, and upgraded to Ubuntu 26.04 with KDE6, which means that any old webtop environments can't be upgraded in place. Please create a new container with a new bind mounted volume for user data. You can also use the new webtop creation wizard from within XPipe for this. The Kasm Workspace setup is also no longer supported as this required a KasmVNC-based container. With this inconvenience out of the way, Selkies is a much better option for the webtop, which you can see for yourself.
...
[Documentation](https://docs.xpipe.io/guide/webtop)
...
[Documentation](https://docs.xpipe.io/guide/team-vault)
...
Simply create an RD gateway entry and set it as a gateway for your RDP connection. SSH gateways via tunneling are also still supported for RDP, you can now choose between both of these gateway types. This feature will be available in the Professional plan, but is also available for free for a few weeks after release.
...
[Documentation](https://docs.xpipe.io/guide/python-api)
...
- The MCP server received various fixes for SSE issues with certain MCP clients
