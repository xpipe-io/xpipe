...
public abstract class ScanProvider {
    ...
    public static class Loader implements ModuleLayerLoader {
        ...
        public void init(ModuleLayer layer) {
            ALL = ServiceLoader.load(layer, ScanProvider.class).stream().map(ServiceLoader.Provider::get).sorted(
                    Comparator.comparing(scanProvider -> scanProvider.getClass().getName())).collect(Collectors.toList());
        }
