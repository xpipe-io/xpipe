...
public class AppRelease {
    ...
    public static AppRelease of(String tag) {
        ...
        var url = "https://github.com/xpipe-io/%s/releases/download/%s/%s".formatted(AppProperties.get().isStaging() ? "xpipe-ptb" : "xpipe", tag,
                name);
        var browser = "https://github.com/xpipe-io/%s/releases/%s".formatted(AppProperties.get().isStaging() ? "xpipe-ptb" : "xpipe", tag);
