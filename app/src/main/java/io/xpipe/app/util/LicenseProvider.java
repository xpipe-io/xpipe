...
public abstract class LicenseProvider {
    ...
    public static class Loader implements ModuleLayerLoader {
        ...
        public void init(ModuleLayer layer) {
            INSTANCE = ServiceLoader.load(layer, LicenseProvider.class).stream().map(ServiceLoader.Provider::get).findFirst().orElseThrow(
                    () -> ExtensionException.corrupt("Missing license provider."));
        }
