    ...
    public Comp<?> create() {
        ...
        builder.addTitle("gitSync")
                .sub(new OptionsBuilder()
                        ...
                        .addComp(prefs.getCustomOptions("gitUsername").buildComp()
                                .maxWidth(600))
                        .addComp(prefs.getCustomOptions("gitPassword").buildComp()
                                .maxWidth(600))
                        .addComp(prefs.getCustomOptions("gitVaultIdentityStrategy").buildComp()
                                .maxWidth(600))
