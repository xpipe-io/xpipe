...
import io.xpipe.app.store.ValidatableStore;
...
public class StoreCreationModel {
    ...
    public StoreCreationModel(
        ...
        this.name = new SimpleStringProperty(
                !isTemplate() ? initialName != null && !initialName.isEmpty() ? initialName : null : null);
    ...
    boolean isTemplate() {
        return existingEntry != null
                && (existingEntry.getUuid().equals(StoreQuickConnect.STORE_ID) || existingEntry.isTemplate());
    }
